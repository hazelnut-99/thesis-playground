...
strategy_order = ["disabled", "tail-age", "free-mem", "hits", "marginal-hits", "optimal"]
strategy_labels = {
...
plt.savefig("../../figures/synth_202_fixed_interval_barplots.pdf", bbox_inches="tight", dpi=300)
plt.close()