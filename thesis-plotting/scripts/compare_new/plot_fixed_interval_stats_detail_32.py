...
def plot_figure(strategy, key_a, ylabel_a, key_b, ylabel_b, filename, title_a=None, title_b=None, y_a_ticks=None, aggregate_window=1):
    ...
    star_map = {0: 0, 1: 12, 2: 0, 3: 12, 4: 8}
...
plot_figure(
    ...
    filename="synth_static_202_stats_detail_tail_age_32.pdf",
    aggregate_window=2
)
...
plot_figure(
    ...
    key_b="num_slabs",
    ylabel_b="Number of Slabs",
    filename="synth_static_202_stats_detail_eviction_rate_32.pdf",
    aggregate_window=2
)
...
plot_figure(
    ...
    key_b="num_slabs",
    ylabel_b="Number of Slabs",
    filename="synth_static_202_stats_detail_hits_32.pdf",
    aggregate_window=2
)
...
plot_figure(
    ...
    key_b="num_slabs",
    ylabel_b="Number of Slabs",
    filename="synth_static_202_stats_detail_marginal_hits_32.pdf",
    aggregate_window=2
)