...
cluster_name = "cluster32"
file_path = f"/nfs/hongshu/traces/{cluster_name}.csv"

# Read CSV and drop unnecessary columns
df = spark.read.csv(file_path, header=True, inferSchema=True).drop("next_access_vtime", "clock_time")

first_clock_time = 0
last_clock_time = 626075
time_span = last_clock_time - first_clock_time 
