...
trace_names = ["twitter_cluster17", "twitter_cluster49", "twitter_cluster50", "twitter_cluster53", "twitter_cluster11", "meta_202210_kv_traces_all_sort"]
    
working_set_ratios = [0.01, 0.05, 0.1]
...
def generate_configs(
    ...
    work_dir=f"{HOME_DIR}/thesis-playground/paper-exp/case_study/work_dir_1",
    force_delete=False
):
    total_confs = 0
    new_confs = 0
