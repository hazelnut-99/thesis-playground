...
trace_names = ['wiki_2019u', 'wiki_2016u', 'wiki_2019t', 
               'meta_rprn', 'meta_reag', 'meta_rnha', 'tencent_photo1', 'tencent_photo2']
...
def generate_configs(
    ...
    work_dir=f"{HOME_DIR}/thesis-playground/paper-exp/efficiency/work_dir_cdn",
    force_delete=False
):
    total_confs = 0
    new_confs = 0
        ...
        for wsr in working_set_ratios:
            for rebalanceStrategy, rebalanceParamsList in cache_configs.items():
                ...
                for param in rebalanceParamsList:
                    ...
                    cachebench_config["test_config"]["ignoreLargeReq"] = True
                    ...
                    meta_config = {
                        ...
                        "uuid": uuid,
                        "memory_requirement": cachebench_config["cache_config"]["cacheSizeMB"] + 1024,
                        "cpu_requirement": 2.5,  
