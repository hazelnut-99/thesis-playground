...
trace_names = ['meta_202210_kv', 'meta_202401_kv', 'meta_memcache_2024_kv', 'twitter_cluster53'] 
...
cache_configs = {
    ...
    "tail-age": [{"rebalanceDiffRatio": diff_ratio, "wakeUpRebalancerEveryXReqs": wakeup} for diff_ratio, wakeup in itertools.product([0.25], rebalance_intervals)],
...
def generate_configs(
    ...
    work_dir=f"{HOME_DIR}/thesis-playground/paper-exp/efficiency/work_dir_meta_detailed_wsr",
    force_delete=False
):
    total_confs = 0
    new_confs = 0
