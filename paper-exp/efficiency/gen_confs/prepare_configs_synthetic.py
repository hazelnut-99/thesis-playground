...
def read_trace_info_csv(csv_path):
    ...
    trace_dict = {
        ...
        "synth_static_204": {
            "download_path": "placeholder",
            "file_name": "synth_static_204.csv",
            "slab_size": 4,
            "wss": 1.7773,
            "num_slab_classes": 5,
            "number_of_requests": 80000000,
        ...
        "synth_dynamic_400": {
            "download_path": "placeholder",
            "file_name": "synth_dynamic_400.csv",
            "slab_size": 4,
            "wss": 2.8916,
            "num_slab_classes": 5,
            "number_of_requests": 80000000,
...
trace_names = ["synth_static_202", "synth_static_204", "synth_dynamic_400"]
...
cache_configs = {
    ...
    "tail-age": [{"rebalanceDiffRatio": diffRatio, "wakeUpRebalancerEveryXReqs": wakeup} 
                 for diffRatio, wakeup in itertools.product([0.02, 0.05, 0.1, 0.25], rebalance_intervals)],
...
def generate_configs(
    ...
    work_dir=f"{HOME_DIR}/thesis-playground/paper-exp/efficiency/work_dir_synthetic",
    force_delete=False
):
    total_confs = 0
    new_confs = 0
