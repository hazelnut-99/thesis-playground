...
rebalance_intervals = [10_000, 20_000, 50_000, 100_000, 200_000, 500_000]

default_decay = 0.3
decay_factors = [0.1, 0.3, 0.5]

default_initial_threshold = 2
initial_thresholds = [1, 2, 4, 8]

default_additive_step = 2
additive_steps = [1, 2, 4, 8]

default_emr_low = 0.5
emr_lows = [0.3, 0.4, 0.5]

default_emr_high = 0.95
emr_highs = [0.85, 0.9, 0.95]
...
cache_configs = {
    "marginal-hits-new": [
    ...
    ] + [
        {
            ...
            "mhMovingAverageParam": decay_factor,
            "mhOnlyUpdateHitIfRebalance": False,
        ...
        for initial_thresh in initial_thresholds
    ] + [
        {
            "wakeUpRebalancerEveryXReqs": default_interval,
            "mhMovingAverageParam": default_decay,
            "mhOnlyUpdateHitIfRebalance": False,
            "minRequestsObserved": default_interval,
            "mhMinDiff": default_initial_threshold, 
            "mhMinDiffRatio": 0.00,
            "thresholdAIADStep": additive_step,
            "thesholdMIMDFactor": 2.0,
            "emrLow": default_emr_low,
            "emrHigh": default_emr_high,
            "thresholdAI": True,
        ...
        for additive_step in additive_steps
    ] + [
        {
            "wakeUpRebalancerEveryXReqs": default_interval,
            "mhMovingAverageParam": default_decay,
            ...
            "mhMinDiff": default_initial_threshold, 
            "mhMinDiffRatio": 0.00,
            "thresholdAIADStep": default_additive_step,
            "thesholdMIMDFactor": 2.0,
            "emrLow": emr_low,
            "emrHigh": default_emr_high,
            "thresholdAI": True,
