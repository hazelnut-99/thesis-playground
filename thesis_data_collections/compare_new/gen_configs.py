...
allocators = ['SIMPLE2Q']
wakeUpRebalancerEveryXReqs = [50_000]
...
rebalanceStrategies = {
    ...
    "eviction-rate": [{"rebalanceDiffRatio": 0.1, "wakeUpRebalancerEveryXReqs": wakeup} for wakeup in wakeUpRebalancerEveryXReqs],
    ...
    for allocator, (rebalanceStrategy, rebalanceParamsList) in \
        ...
        for rebalanceParams in rebalanceParamsList:  # Iterate over list of configurations
            for cache_size in info['cache_sizes']:
                ...
                if "ignoreLargReq" in info and info['ignoreLargReq']:
                    test_config["ignoreLargReq"] = True
                memo_config = {
