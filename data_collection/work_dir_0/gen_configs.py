...
cache_configs = {
    "allocFactor": [(1.15, False), (1.25, True), (1.35, False), (1.5, False)],
...
for trace_name, info in trace_info_dict.items():
    ...
    for config, allocator, (rebalanceStrategy, rebalanceParams), ws_ratio in itertools.product(
        configs, allocators, rebalanceStrategies.items(), workingSetRatios
    ):
        ...
        cache_config = {
            ...
            "allocFactor": config["allocFactor"][0],
            ...
            "wakeUpRebalancerEveryXReqs": 5000,
            **rebalanceParams
        }
        test_config = {
            "numOps": op_count,
