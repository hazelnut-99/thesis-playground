...
rebalanceStrategies = {
    "marginal-hits": [
        ...
        {"tailSlabCnt": 1, "mhMovingAverageParam": 0.3, "wakeUpRebalancerEveryXReqs": wakeup, "useAdaptiveRebalanceIntervalV2": True, "intervalAdjustmentStrategy": "miad"}
        for wakeup in wakeUpRebalancerEveryXReqs
    ] + [
        {"tailSlabCnt": 1, "mhMovingAverageParam": 0.3, "wakeUpRebalancerEveryXReqs": wakeup, "useAdaptiveRebalanceIntervalV2": True, "intervalAdjustmentStrategy": "mimd"}
        for wakeup in wakeUpRebalancerEveryXReqs
    ] + [
        {"tailSlabCnt": 1, "mhMovingAverageParam": 0.3, "wakeUpRebalancerEveryXReqs": wakeup, "useAdaptiveRebalanceIntervalV2": True, "intervalAdjustmentStrategy": "aiad"}
        for wakeup in wakeUpRebalancerEveryXReqs
    ] + [
        {"tailSlabCnt": 1, "mhMovingAverageParam": 0.3, "wakeUpRebalancerEveryXReqs": wakeup, "useAdaptiveRebalanceIntervalV2": True, "intervalAdjustmentStrategy": "aimd"}
        for wakeup in wakeUpRebalancerEveryXReqs
    ] + [
        {"tailSlabCnt": 1, "mhMovingAverageParam": 0.3, "wakeUpRebalancerEveryXReqs": wakeup, "useAdaptiveRebalanceIntervalV2": True, "intervalAdjustmentStrategy": "miad", "useAnomalyDetection": True}
        for wakeup in wakeUpRebalancerEveryXReqs
    ], 
